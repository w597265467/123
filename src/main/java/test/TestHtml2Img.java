 ...
 * @create 2018-03-20 11:25

 * @desc TestHtml2Img

 **/
public class TestHtml2Img extends JPanel {
	// 行分隔符
	 ...
	 * @return boolean
	 */
	public TestHtml2Img(final String file, final String url, final String WithResult) {
	...
	public static boolean printUrlScreen2jpg(final String file, final String url, final int width, final int height) {
		...
		SwingUtilities.invokeLater(() -> {
			...
			frame.getContentPane().add(new TestHtml2Img(file, url, withResult),
					BorderLayout.CENTER);
	...
	public static void main(String[] args) {
		...
		TestHtml2Img html2Img = new TestHtml2Img("D://1.jpg","https://www.baidu.com","");
		TestHtml2Img.printUrlScreen2jpg("1122.jpg", "https://www.baidu.com", 1400, 900);
