...
public class PDFUtil {
	...
	static {
		try {
			BaseFont.createFont("/Users/wangluyao/jf/123/font/msyhl.ttc,1",BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
	...
	public PDFUtil() throws IOException, DocumentException {

	}


	public static void main(String[] args) throws Exception {
		imageWaterMark(createPDF(), "/Library/Screen Savers/Default Collections/3-Cosmos/Cosmos02.jpg");
	}
	...
	public static String createPDF() throws Exception {
		...
		//手指图片
		Image hand = Image.getInstance("/Library/Screen Savers/Default Collections/3-Cosmos/Cosmos02.jpg");
