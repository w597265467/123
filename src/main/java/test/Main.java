...
public class Main extends JPanel {
	...
	public Main(final String url, final int maxWidth, final int maxHeight) {
		...
		final String fileName = "C:\\Users\\Administrator\\Desktop\\img\\" +System.currentTimeMillis() + ".jpg";
		...
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				frame.getContentPane().add(
						new Main("http://www.zhihu.com/question/21395848", 6400, 4800),
						BorderLayout.CENTER);
